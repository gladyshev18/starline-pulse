...
Все уведомления отправляются без звука. Worker автоматически присылает отчёты по московскому времени:

- ежедневный — в 09:00 за предыдущий день;
- еженедельный — в понедельник в 09:00 за предыдущую неделю;
- ежемесячный — первого числа в 09:00 за предыдущий месяц.
